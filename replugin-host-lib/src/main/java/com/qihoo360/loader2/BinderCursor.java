...
public class BinderCursor extends MatrixCursor {
    ...
    /**
     * 这里创建了
     * BinderCursor返回了，BinderCursor在构造中创建一BinderParcelable并传入了Binder，
     * 然后将这个BinderParcelable存入了BinderCursor中的一个Bundle中。现在我们在回到去看一下第18步中，
     * 通过Provider得到cursor，然后从cursor中取出的Binder就是PmHostSvc
     * @param binder
     * @return
     */
